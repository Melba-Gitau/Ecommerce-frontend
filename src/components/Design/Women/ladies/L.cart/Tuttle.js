...
import tuttle from "../sweaters/cozy.jpg";
      ...
      <div className="row">
        ...
        >
          ...
          <div className="content">
            <h4>
              <i>
                <u>Turtleneck Sweaters</u>
              </i>
            </h4>
            <ul>
              <li>
                Women's Long Sleeve Turtleneck Sweater Chunky Cable Knit
                Oversized Pullover Jumper Tops.
              </li>
              <li>Ksh.400</li>
            </ul>
            <p>
