...
import shorts from "../../pants/shorts.jpg";
  ...
  return (
    <div className="brace">
      ...
      <div className="row">
        ...
        >
          <img src={shorts} alt="" style={{ height: "90%" }} />
          <div className="content">
            ...
            <ul>
              <li>
                Looking for a comfortable yet stylish option for summer?Denim,
                Lace up, Beach shorts, we've got them all.
              </li>
              <li>Ksh.250</li>
            </ul>
            <p>
